...
// Set color with !important on the span
...
// Use MutationObserver to correct color if it changes to black
...
finalSpan.style.setProperty('color', initialColor, 'important');
console.log("[🔹] Corrected to:", initialColor);
}
}
});
...
setTimeout(replaceFirstName, 400);
